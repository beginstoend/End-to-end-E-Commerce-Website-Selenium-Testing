...
public HomePage hp;
	...
	public WebDriver initilizeWebApp() throws IOException
	{
		
		
		Properties prop = new Properties();
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\java\\Components\\Resources\\globalData.properties");
		prop.load(fis);
